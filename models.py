...
class Net2(nn.Module):
    ...
    def __init__(self):
        ...
        ## 1. This network takes in a square (224 x 224), grayscale image as input
        ...
        # 4 - 64 output channels/feature maps, 3x3 square convolution kernel
        # 2x2 max pooling with 10% droupout
        # ConvOut: (256, 26, 26) <-- (W-F+2p)/s+1 = (26 - 1)/1 + 1 
        # PoolOut: (256, 13, 13) <-- W/s 
