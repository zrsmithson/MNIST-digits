...
class Net2(nn.Module):
    ...
    def __init__(self):
        ...
        ## This network takes in a square (28 x 28), grayscale image as input
        ...
        # ConvOut: (32, 25, 25) <-- (W-F+2p)/s+1 = (28 - 4)/1 + 1 
        # PoolOut: (32, 12, 12) <-- W/s 
        ...
        # ConvOut: (64, 10, 10) <-- (W-F+2p)/s+1 = (12 - 3)/1 + 1 
        # PoolOut: (64, 5, 5) <-- W/s 
        ...
        # ConvOut: (128, 4, 4) <-- (W-F+2p)/s+1 = (5 - 2)/1 + 1 
        # PoolOut: (128, 2, 2) <-- W/s 
